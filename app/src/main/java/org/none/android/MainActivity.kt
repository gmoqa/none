...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var pagerAdapter: org.none.android.adapters.ButtonPageAdapter
    ...
    private fun initializeServices() {
        ...
        analyticsService.logScreenView("Main Screen", "MainActivity")
        ...
        // Set user properties
        val configuredCount = getSharedPreferences("TeaBoardPrefs", MODE_PRIVATE)
            .getInt("configured_buttons_count", 0)
        analyticsService.setButtonsConfiguredCount(configuredCount)
        analyticsService.setUsesGoogleDrive(syncEnabled)
    }
    ...
    private fun initializeViews() {
        ...
        pagerAdapter = org.none.android.adapters.ButtonPageAdapter(
    ...
    private fun toggleEditMode() {
        ...
        // Log mode toggle
        analyticsService.logModeToggled(if (isEditMode) "edit" else "use")
    ...
    private fun playButtonSound(buttonId: Int) {
        ...
        // Log button press
        analyticsService.logButtonPressed(buttonId)
