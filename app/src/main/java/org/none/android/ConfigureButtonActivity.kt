...
import org.none.android.BuildConfig
import org.none.android.models.ButtonConfig
import org.none.android.audio.AudioPlayer
import org.none.android.audio.AudioRecorder
import org.none.android.audio.AndroidAudioPlayer
import org.none.android.audio.AndroidAudioRecorder
import org.none.android.storage.StorageService
import org.none.android.services.StorageServiceFactory
...
import org.none.android.constants.ValidationConstants
...
class ConfigureButtonActivity : AppCompatActivity() {
    ...
    private val takePictureLauncher = registerForActivityResult(
        ...
        if (success && currentPhotoUri != null) {
            ...
            // Log image captured analytics
            analyticsService.logImageCaptured(buttonId, "camera")
        } else {
            if (BuildConfig.DEBUG) {
    ...
    private val selectImageLauncher = registerForActivityResult(
        ...
        uri?.let {
            ...
            // Log image captured analytics
            analyticsService.logImageCaptured(buttonId, "gallery")
        }
    }
    ...
    private fun initializeServices() {
        ...
        // Log screen view
        analyticsService.logScreenView("Configure Button", "ConfigureButtonActivity")
                ...
                try {
                    ...
                    runOnUiThread {
                        if (trimmedFile != null && trimmedFile.exists()) {
                            ...
                            // Log audio recording analytics
                            val durationSeconds = (trimmedFile.length() / 1000).toInt() // Approximate duration
                            analyticsService.logAudioRecorded(buttonId, durationSeconds)
                        } else {
                    ...
                    runOnUiThread {
                        ...
                        // Log audio recording analytics
                        val durationSeconds = (audioFile.length() / 1000).toInt() // Approximate duration
                        analyticsService.logAudioRecorded(buttonId, durationSeconds)
                    }
                }
            }
        ...
        lifecycleScope.launch {
            try {
                ...
                runOnUiThread {
                    ...
                    // Log button configuration analytics
                    analyticsService.logButtonConfigured(
                        buttonId = buttonId,
                        hasImage = currentImageFile != null,
                        hasAudio = currentAudioFile != null
                    )
